    ...
    <>
      <div className="profilePageContainer">
        <div className="profileRight">
          <div className="profileRightTop">
            ...
            <div className="profileInfo">
              <div>
                ...
                <span className="hobby">Loves gardening</span>
              </div>
              <button className="editProfileButton">
                Edit Profile <EditProfile />
              </button>
              <div className="userDetails">
                <span className="location">New York, United States</span>
                <span className="friendsCounter">3654 Friends</span>
              </div>
          ...
          <div className="profilrRightBottom"></div>
        </div>
      ...
      {useMediaQuery("(min-width: 660px)") ? <ProfileRightBar /> : null}
    </>
  );
};
